...
{
    public abstract class BarKitchenDAO : BaseDao
    {
        ...
        private OrderOverview ReadTable(DataTable dataTable)
        {
            OrderOverview orderOverview = GetOverviewType();
            ...
            foreach (DataRow dr in dataTable.Rows)
            {
                ...
                orderOverview.OrderId = (int)dr["OrderID"];
                orderOverview.TableId = (int)dr["TableId"];
                orderOverview.Add(orderGerecht);
            }
        ...
        //{
        //    List<OrderOverview> barOrderOverviews = List<>;
        ...
        public abstract OrderOverview GetOverviewType();
    }
}
